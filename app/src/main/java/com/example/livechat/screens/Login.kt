...
@Composable
fun Login(navController: NavController,vm:LCViewModel) {
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Column(modifier = Modifier
            ...
            Text(text = "SignIn", Modifier.padding(top = 8.dp),
            ...
            OutlinedTextField(value = passwordState, onValueChange = {
                ...
                keyboardActions = KeyboardActions(
                    onDone = {
                        vm.SingInFunction(emailState.text.trim(),passwordState.text.trim(),navController,vm)
                    }
                )
            )
            Button(onClick = {
...
//                navigateTo(navController,DestinationScreens.profile.route)
            ...
            Text(text = "Create an account? Go to SignUp ->",
                color= Color.Blue,
                modifier = Modifier
                    .padding(8.dp)
                    .clickable {
                        navigateTo(navController, DestinationScreens.singUp.route)
